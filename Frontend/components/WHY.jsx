        ...
        <section className="relative z-10 max-w-6xl mx-auto px-6 sm:px-12 py-16">
          <div className="text-center mb-12">
            <p className="text-lg sm:text-xl text-gray-300">
              At <span className="text-[#b2d438] font-bold">PulseFit</span>, we help you go beyond limits and unlock your true potential. Here’s what makes us stand out:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[#6d6d6d] rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <div className="text-4xl mb-4">💪</div>
              <h3 className="text-xl font-semibold mb-2 text-[#b2d438]">Expert Trainers</h3>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[#6d6d6d] rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <div className="text-4xl mb-4 ">🕒</div>
              <h3 className="text-xl font-semibold mb-2 text-[#b2d438]">Flexible Membership Options</h3>
