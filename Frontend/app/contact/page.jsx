            ...
            <div className="min-h-screen bg-transparent">
                ...
                <div className="max-w-5xl w-full bg-gray-600/50 shadow-lg rounded-lg p-8 lg:p-12 flex flex-col lg:flex-row gap-8 mx-auto">
                    <div className="flex-1">
                        <h2 className="text-3xl font-extrabold text-orange-400 mb-6">Get in Touch</h2>
                        <form action="#" method="POST" className="space-y-4">
                            <div>
                                <label for="name" className="block text-lg font-medium text-orange-400">Your Name</label>
                            ...
                            <div>
                                <label for="email" className="block text-lg font-medium text-orange-400">Your Email</label>
                                <input type="email" id="email" name="email" required
                                    className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-orange-500 focus:border-orange-500" />
                            </div>
                            <div>
                                <label for="message" className="block text-lg font-medium text-orange-400">Your Message</label>
                            ...
                            <div>
                                <button type="submit"
                                    className="w-full px-6 py-3 bg-orange-500 text-white text-lg font-extrabold rounded-lg shadow hover:bg-transparent hover:text-orange-500 transition">
                                    Send Message
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="flex-1 border-l-2 border-gray-300 pl-6 my-auto">
                        <h2 className="text-3xl font-extrabold text-orange-400 mb-2">Contact Information</h2>
                        <div class="space-y-4">

                            <div className="flex items-center">
                                <div className="p-3 bg-orange-500 text-white rounded-full text-3xl mt-8"> <MdEmail/> </div>
                                <div className="ml-4">
                            ...
                            <div className="flex items-center">
                                <div className="p-3 bg-orange-500 text-white rounded-full mt-8 text-3xl"> <MdEmail/> </div>
                                <div className="ml-4">
