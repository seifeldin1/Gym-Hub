  ...
  <h1 className="relative text-4xl font-bold text-white z-10"> WHY CHOOSE US</h1>
    ...
    const Gallery = () =>{
      ...
      <h1 className="relative text-4xl font-bold text-white z-10"> Our Gallery</h1>
        ...
        <Image src={gall1.src}  alt="Gallery-1"  width={300} height={300} className="hover:opacity-50 " />
        <Image src={gall2.src}  alt="Gallery-2"  width={300} height={300} className="hover:opacity-50"/>
        <Image src={gall3.src}  alt="Gallery-3"  width={300} height={300} className="hover:opacity-50" />
        <Image src={gall4.src}  alt="Gallery-4"  width={300} height={300} className="hover:opacity-50"/>
        <Image src={gall5.src}  alt="Gallery-5"  width={300} height={300} className="hover:opacity-50"/>
        <Image src={gall6.src}  alt="Gallery-6"  width={300} height={300} className="hover:opacity-50"/>
        <Image src={gall7.src}  alt="Gallery-7"  width={300} height={300} className="hover:opacity-50"/>
        <Image src={gall8.src}  alt="Gallery-8"  width={300} height={300} className="hover:opacity-50"/>
        </div>
